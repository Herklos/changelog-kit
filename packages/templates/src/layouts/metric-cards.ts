...
function statOf(entry: ChangelogEntry & { stat?: unknown }, index: number): string {
...
const ACCENT_KEY: Record<string, EntryKind> = { update: 'update', bugfix: 'bugfix', improvement: 'improvement', soon: 'soon' };

/**
 * "By the numbers": the release as three or four oversized figures. Reads in
 * a scroll — the format for a launch-day square post.
 */
export const metricCards: TemplateDef = {
  id: 'metric-cards',
  name: 'Metric cards',
