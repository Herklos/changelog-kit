...
import type { BadgeColorMap } from '@changelog-kit/brand';

const NODE_COLOR_KEY: Record<string, keyof BadgeColorMap> = { update: 'update', bugfix: 'bugfix', improvement: 'improvement', soon: 'soon' };
const GUTTER = 32;
 ...
 */
export const timelineRail: TemplateDef = {
  id: 'timeline-rail',
  name: 'Timeline rail',
