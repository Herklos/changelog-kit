...
import type { TemplateDef } from './context.js';
...
export const builtinTemplates: Record<string, TemplateDef> = Object.fromEntries(
  [
...
export function defineTemplate(spec: Partial<TemplateDef> & { id: string; render: TemplateDef['render'] }): TemplateDef {
